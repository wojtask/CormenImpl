...
public class HashTableWithFreeList<E> extends ZeroBasedIndexedArray<HashTableWithFreeList.Position<E>> {
    ...
    public static class Position<F> {
        ...
        /**
         * Creates a free position with given indices to a previous and a next position.
         *
    ...
    public static class Element<F> {
        ...
        /**
         * Creates an element with given key and satellite data.
         *
    ...
    /**
     * Creates an empty hash table of an underlying array of given length and hash function.
     *
     ...
     */
    public static <E> HashTableWithFreeList<E> ofLengthAndHashFunction(int length, HashFunction h) {
